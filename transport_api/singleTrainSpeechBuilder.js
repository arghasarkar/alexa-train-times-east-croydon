...
const generateSpeechText = (ORIGIN_CODE, DESTINATION_CODE) => {
    ...
    let speechText = `The next train from ${ORIGIN_CODE} to ${DESTINATION_CODE} departs at ${departureTime} from platform number ${platform}. The departure status is ${status}. Train operator is ${operator}`;
